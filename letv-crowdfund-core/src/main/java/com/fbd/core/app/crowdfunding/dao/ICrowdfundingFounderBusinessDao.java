...
public interface ICrowdfundingFounderBusinessDao extends BaseDao<CrowdfundingFounderBusinessModel>{
     ...
     * 查询列表
     */
    public List<CrowdfundingFounderBusinessModel> selectList(CrowdfundingFounderBusinessModel model);
}