...
%>
<script type="text/javascript" src="<%=path%>/js/withdraw/withdrawFailList.js"></script>
	<form id="list_search">
		<div class="seach_div">
	...
	<security:authorize access="hasPermission(null, 'security.operation.finance_fail_withdraw_export')">
		<input type="hidden" id="finance_fail_withdraw_export"/>
	</security:authorize>
