...
%>
<script type="text/javascript" src="<%=path%>/js/withdraw/withdrawPassedList.js"></script>
	<form id="list_search">
		<div class="seach_div">
	...
	<security:authorize access="hasPermission(null, 'security.operation.finance_passed_withdraw_export')">
		<input type="hidden" id="finance_passed_withdraw_export"/>
	</security:authorize>
