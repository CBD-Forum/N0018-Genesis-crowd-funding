...
<script type="text/javascript" src="<%=path%>/js/crowdfund/backAdd.js"></script>
	<div class="prodiv" style="height:500px; overflow: auto;">
			...
			<div id="draft_basic" style="padding:20px 10px;border-bottom:1px solid #CCC;">
				<form id="baseForm" method="post">
					...
					<div class="x-form-item">
						<label class="x-form-item-label">限定名额:</label>
						<div class="x-form-element">
							<input type="text" name="numberLimits"/>个 <span style="color:#cccccc">“0”为不限名额</span> 
						</div>
					</div>
					<div class="x-form-item">
					...
					<!-- <div class="x-form-item">
						<label class="x-form-item-label" style="width:80px;">预计每日收益:</label>
						<div class="x-form-element">
					...
					<!-- <div class="x-form-item">
						<label class="x-form-item-label" style="width:80px;">回报展示类别:</label>
						<div class="x-form-element">
					...
					<div class="x-form-item">
						<label class="x-form-item-label">说明图片:</label>
