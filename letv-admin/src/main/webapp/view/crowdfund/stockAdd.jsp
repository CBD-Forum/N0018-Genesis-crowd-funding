		...
		<div id="baseInfo" style="padding-top:20px;padding-bottom:20px;border:1px solid #00b7ee;">  
			<form id="baseForm" method="post">
				...
				<div class="x-form-item">
					...
					<div class="x-form-element">
						<input type="text" name="fundAmt" id="fundAmt" class="input easyui-numberbox" precision="2" />
					</div>
				</div>
				...
				<div class="x-form-item" id="overFundAmtDiv" style="display: none">
					...
					<div class="x-form-element">
						<input type="text" name="overFundAmt" id="overFundAmt"/>
					</div>
				</div>	
				<div class="x-form-item" id="overFundAmtDiv">
					<label class="x-form-item-label">每份金额:</label>
					<div class="x-form-element">
						<input type="text" name="stockPartAmt" id="stockPartAmt" precision="2"/> 
					</div>
				</div>
				<div class="x-form-item" id="overFundAmtDiv">
...
<!-- 				    <div class="x-form-element">
			 ...
			 <!-- 运营数据信息 -->
			 <div id="operateInfo" style="padding-top:20px;padding-bottom:20px;border:1px solid #00b7ee;">
			 	 <font size="3">预计收益信息：</font>
			 	 <table id="operateTable"></table>
		     </div>		 
			 
			 <!-- 创始人信息 -->
			 <div id="founderInfo" style="padding-top:20px;padding-bottom:20px;border:1px solid #00b7ee;">
			 ...
			 <div id="companyInfo" style="padding-top:20px;padding-bottom:20px;border:1px solid #00b7ee;">
			    <form id="companyForm" method="post">
					...
					<div class="x-form-item">
						<label class="x-form-item-label">上一轮估值:</label>
						<div class="x-form-element">
							<input type="text" name="lastValuation" id="lastValuation"/>
						</div>
					</div>								
					<div class="x-form-item">
			 ...
			 <!-- 项目附件 -->
			 <div id="fileInfo" style="padding-top:20px;padding-bottom:20px;border:1px solid #00b7ee;">
	    ...
	    <!-- 添加创始人信息 --> 
		<div id="founderAdd"  style="display:none">
	     ...
	     <!-- 添加运营数据信息 --> 
		<div id="operateAdd" style="display:none">
