$(function(){
	searchData("/crowdfunding/getPageCrowdList.html?loanState=end&fixLoanType=divideShare");
    //获取项目所在省
...
function searchData(dUrl){
	...
	var columns = [[
	                ...
	                {field:'operate',title:'操作',align:'center',width:160,formatter:operateData},
