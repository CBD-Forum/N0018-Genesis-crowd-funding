$(function(){
	searchData("/crowdfunding/getPageCrowdList.html?loanState=lended&fixLoanType=sending");
    //获取项目所在省
...
/*	                {field:'operate',title:'操作',align:'center',width:120,formatter:operateData},*/
					...
					{field:'view',title:'详细',align:'center',width:220,formatter:operateData1}
				]];
