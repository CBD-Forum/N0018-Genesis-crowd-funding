...
$.validator.addMethod("mobile", function(value, element) { 
	...
	var mobile = /^((\+86)|(86))?(1[3|5|7|8|])\d{9}$/;
...
$.validator.addMethod("idcard", function(value, element) { 
	var tel = /^((1[1-5])|(2[1-3])|(3[1-7])|(4[1-6])|(5[0-4])|(6[1-5])|71|(8[12])|91)\d{4}((19\d{2}(0[13-9]|1[012])(0[1-9]|[12]\d|30))|(19\d{2}(0[13578]|1[02])31)|(19\d{2}02(0[1-9]|1\d|2[0-8]))|(19([13579][26]|[2468][048]|0[48])0229))\d{3}(\d|X|x)?$/; 
	return this.optional(element) || (tel.test(value)); 
}, "身份证号码格式错误");
...
$.validator.addMethod("dateComp", function(value, element) { 
	 var date1= new Date(Date.parse(value.replace(/-/g,"/")));   
     var date2= new Date();   
     var r = date1-date2;
	 return this.optional(element) || (r>0); 
}, "发放开始时间小于当前时间");

$.validator.addMethod("dateCompdate", function(value, element,param) { 
	var target = $( param );
	if ( this.settings.onfocusout ) {
		target.unbind( ".validate-equalTo" ).bind( "blur.validate-equalTo", function() {
			$( element ).valid();
