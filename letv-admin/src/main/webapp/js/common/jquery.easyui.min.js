...
return _28e(_295);
},mask:function(_296,msg,icon,fn){
	$("<div class=\"window-mask\"></div>").appendTo('body').css({width:'100%',height:'100%'});
	$("<div class=\"datagrid-mask-msg\"></div>").html(msg).appendTo('body').css({display:"block",left:($(window).width()-$("div.datagrid-mask-msg").outerWidth())/2,top:($(window).height()-$("div.datagrid-mask-msg").outerHeight())/2});
...
$.ajax({url:data,type:"post",data:_4b8,dataType:"json",success:function(data){
_4b9(data);
},error:function(){
...
_614.pagination("refresh",{pageNumber:opts.pageNumber||_615.pageNumber,total:data.total});
if(opts.pageNumber!=_615.pageNumber&&_615.pageNumber!=0){
...
return _919;
},mode:"local",method:"post",url:null,data:null,emptyItem:null,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
