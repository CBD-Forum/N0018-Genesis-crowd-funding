$(function(){
	...
	var columns = [[
					...
					{field:'institution',title:'机构性质',width:150,align:'center',sortable:true},
...
//					{field:'leadAuthStateName',title:'状态',width:80,align:'center'}
	...
	$('#userTable').datagrid({
		url: path + "/userAuth/getOrgInvestApplyList.html",
		columns: columns,
		rownumbers : true,
		singleSelect: true,
...
function auditAuth(id,status){
	...
	$.messager.confirm('提示', msg, function(r) {
		if (r) {
			$.ajax({
				type : "POST",
				url : path + '/userAuth/auditOrgInvestorAuth.html',
				data : {
					'id' : id,
