...
@Component
public class BlockChainLoanAccountJob {
	
	

    private static final Logger logger = LoggerFactory.getLogger(BlockChainLoanAccountJob.class);
...
//			blockChainUserJobService.modifyLoanCreateAccount();
		}catch(Exception e){
			e.printStackTrace();
		}
	}
...
//			blockChainUserJobService.modifyLoanActivationAccount();
		}catch(Exception e){
			e.printStackTrace();
		}
	}
...
// 			blockChainUserJobService.modifyLoanTrustAccount(); 			
 		}catch(Exception e){
 			e.printStackTrace();
 		}
 	}
