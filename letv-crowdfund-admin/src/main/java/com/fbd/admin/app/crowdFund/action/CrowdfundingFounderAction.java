...
public class CrowdfundingFounderAction extends BaseAction {
    ...
    public @ResponseBody
    SearchResult<CrowdfundingFounderWorksModel> getFounderWorksList(CrowdfundingFounderWorksModel model) {
    ...
    public @ResponseBody CrowdfundingFounderWorksModel selectFounderWorksById(String id){
