 ...
 * 
 */
@Service("copy/rechargeService")
public class CopyOfRechargeServiceImpl implements IRechargeService {
	
    private static final Logger logger = LoggerFactory.getLogger(CopyOfRechargeServiceImpl.class);
    @Resource
    ...
    public void rechargeTransferAfter(String orderId,String requestID,RechargeModel recharge,Timer timer,boolean notifyFlag){
        ...
        if(BlockChainCore.ResultStatus.TRANSACTION_SUCCESS.equals(query_status)){
    		...
    		recharge.setState(FbdCoreConstants.rachargeState.recharge_success.getValue());
