...
function(t) {
    ...
    return function e(t, n, r) {
        ...
        1 : [function(t, e) { (function(n) {
                ...
                e.exports = t("./main")(r),
                "_Zhichichat_onload" in n && setTimeout(n._Zhichichat_onload, 1)
                    ...
                    var s = function(r) {
                        if (r.source === parent && ("undefined" == typeof c && (c = r.origin), r.origin === c)) {
                            ...
                            case "s":
                                ...
                                v = h[2],
                                m = h[3];
                                if (d !== t.version) throw new Error('Incompatibile Zhichichat! Main site uses: "' + d + '", the iframe: "' + t.version + '".');
        ...
        14 : [function(t, e) { (function(n) {
                ...
                function r(t, e, n) {
                    ...
                    if (arguments.length < 1) throw new TypeError("Failed to construct 'Zhichichat: 1 argument required, but only 0 present");
                    b.call(this),
                    ...
                    if ("https" === g.protocol && !a) throw new Error("SecurityError: An insecure Zhichichat connection may not be initiated from a page loaded over HTTPS");
                ...
                r.prototype._close = function(t, e, n) {
                    var i = !1;
                    if (this._ir && (i = !0, this._ir.close(), this._ir = null), this._transport && (this._transport.close(), this._transport = null, this.transport = null), this.readyState === r.CLOSED) throw new Error("InvalidStateError: Zhichichat has already been closed");
