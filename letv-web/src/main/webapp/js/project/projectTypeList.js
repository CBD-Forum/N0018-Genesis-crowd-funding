...
$(function(){
	...
	getIndexLoanList("preheat", "defaultSort", "indexPreheatList"); //首页预热项目
...
function scrollLeftNav(){
	$(window).scroll(function(){
		if($(document).scrollTop() > $("#hotLoanIndex").offset().top-10 && $(document).scrollTop() < $("#preheatLoanIndex").offset().top){
		...
		}else if($(document).scrollTop() > $("#preheatLoanIndex").offset().top-10 && $(document).scrollTop() < $("#fundingLoanIndex").offset().top){
			$("#indexScrollLoan").find("li").removeClass("cur");
			$("#indexScrollLoan").find("img").attr("src", path + "/images/dian_bai.png");
			...
			$("#indexScrollLoan").find("li").removeClass("cur");
			$("#indexScrollLoan").find("img").attr("src", path + "/images/dian_bai.png");
			$("#indexScrollLoan").find("li").eq(3).addClass("cur");
			$("#indexScrollLoan").find("img").eq(3).attr("src", path + "/images/dian_lan.png");
