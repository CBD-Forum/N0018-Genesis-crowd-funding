            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        //上传到FTP上
                    	var baseServerUrl=editor.options.serverUrl;
                    	baseServerUrl=baseServerUrl.substring(0,baseServerUrl.indexOf('js'))
                        $.ajax({
                    		url: baseServerUrl+'common/uploadByFTP.html',
                    		type: "post",
                    		dataType: "json",
                    		data: {
                    			'path':json.url.substring(0,json.url.lastIndexOf('/')),
                    			'fileName':json.title
                    		},
