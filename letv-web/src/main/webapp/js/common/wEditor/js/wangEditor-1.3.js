                ...
                'createLink': {
                    ...
                    'modal': function (editor) {
                        var urlTxtId = $E.getUniqeId(),
                            ...
                            btnId = $E.getUniqeId();
                            content = '<p style="height:45px;margin-top:20px;"><label>链接：</label><input id="' + urlTxtId + '" type="text" style="width:260px;" value="http://"/><br /></p>' +
                                        '<p style="height:45px;"><label>标题：</label><input id="' + titleTxtId + '" type="text" style="width:260px;"/><br /></p>' + 
                                        '<p style="height:25px;"><label style="height:15px;line-height:15px;">新窗口：</label><input id="' + blankCheckId + '" type="checkbox" checked="checked"/><br /><p>' +
                                        '<button id="' + btnId + '" type="button" class="wangEditor-modal-btn" style="margin-left:30px;">插入链接</button>',
                            $link_modal = $(
