...
<div class="bai_box">
	...
	<div class="fr rg_side clearfix"> 
	   <h4 class="tit_xt clearfix mb20" id="deliveryTitle">发货明细</h4>
       <div id="tabBody">
       		<div id="publicBody"><div></div></div>
       </div>
	   
        <div class="letvPage" id="publicPage" style="margin-right:10px;"></div>
	  </div>
...
<script type="text/javascript" src="<%=path%>/js/userCenter/enterLogicoPublic.js"></script>