...
<div class="equity-info mt50">
	<div class="equity-img">
		<img id="loanCover" style="width:100%; height:100%;" />
    	<div class="pop"></div>
        <a class="pop-f" id="loanName"></a>
    </div>
    <ul class="equity-jd">
    	<li>
    		已筹资<span class="col1" id="approveAmt"></span>万
    		<span class="fr" id="supportRatio1"></span>
    	</li>
        <li class="jd">
        	<div class="jdBar"><span id="pBar" class="back1"></span></div>
            <p class="clearfix">
            	<span class="fl">融资总额：<em id="fundAmt"></em></span>
                <span class="fr">剩余<em id="remainDay"></em>天</span>
            </p>
        </li>
        <li class="bot">
			<!-- <span>项目简介：</span> -->
			<div id="loanDes" style="line-height:22px;"></div>
...
<div class="equity-tab mb50">
	<ul id="entityTab" class="tab">
        ...
        <li code="info"><a href="javascript:void(0);">项目详情</a></li>
    ...
    <div id="entityBody">
    	...
    	<div id="infoBody">
    		...
    		<div class="infobody" id="proInfoContent" style="text-align: center;"><div id="loanDetail" class="proinfo"></div></div>
    	</div>
    	<div id="progressBody">
