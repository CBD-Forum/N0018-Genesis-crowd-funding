	  ...
	  <div class="cp_list clearfix">
	   ...
	   <div class="fr txt_right">
			...
			<span class="fr blockChain" ioc="0"><img src="<%=path%>/images/letv/chartsHover.png">
				...
				<strong style="display:none;">
					...
					<i class="blockChain-address">
						...
						<em class="blockChain-copy"><input class="blockChain-input" id="copyInput" readonly="readonly" type="text" value="werwerwerqweqw2412323" ><a target="_blank" id="copyBtn">复制地址</a><a href="https://charts.ripple.com/#/graph/">去查询</a></em>
					</i>
				</strong>
			</span>
		</p>
		...
		<div class="benefit-setbacks jdbar">
            	...
            	<span class="span4" id="supportRatio1" style="left:0"></span>
        </div>
        <p class="clearfix col6 ft16 ft_bd" style="margin-top:30px;">
		 <span class="fl" id="supportNum1" ></span>
		...
		<p class="mt30 ft16">此项目必须在 <i id="fundEndTime"></i> 前得到 <i id="fundAmt"></i><b class="companyCode"></b> 的支持才可成功！</p>
...
<script type="text/javascript" src="<%=path%>/js/project/loanDetail-public.js"></script>
