	   ...
	   <div class="gq_info">
	    <div class="det_inf" style="margin-left:220px;">
		 ...
		 <div class="mb30 clearfix">
		  ...
		  <p class="fl col9 ft14 ft_bold ml78" style="display:none;">
		 ...
		 <div class="mb20 clearfix">
		  ...
		  <p class="fl col9 ft14 ft_bold ml78" style="display:none;">尾款补齐后预计每日收益： <em class="col_blue" id="income2">0.00</em> <b class="companyCode"></b></p>
		 </div>
		 <p class="clearfix mb20"><span>可用余额：</span><em class="col3" id="balance">0</em> <b class="companyCode"></b><a class="next_button fr chz_btn2" href="<%=path%>/common/recharge.html">充入</a></p>
		 <div class="mb30 clearfix">
		 ...
		 <a class="next_button" id="investFBtn">确认支付尾款</a>
		</div>
	   </div>
...
<script type="text/javascript" src="<%=path%>/js/project/stock-retainage.js"></script>