...
<div class="box pt30 gy_info">
   ...
   <div class="gy_infom" style="width:885px;">
	...
	<div class="mb18 clearfix">
	 ...
	 <p class="fl col_gray" style="margin-top:110px;">建议尺寸：（132*132px），支持jpg、jpeg、png，大小不超过5M。</p>
	</div>
	<div class="mb18 clearfix rel">
	 ...
	 <i class="tian" style="left: 550px;"><b class="companyCode"></b></i>
	</div>
	<div class="mb18 clearfix rel">
	...
	<div class="mb18 clearfix">
	 ...
	 <p class="fl col_gray" style="margin-top:110px;"> 建议尺寸：（640*480px）支持jpg、jpeg、png格式，大小不超过5M。</p>
	</div>
	<div class="mb18 clearfix">
	...
	<div class="mb18 clearfix">
	 ...
	 <input type="text" class="fl" id="loanIntroduction" nullMessage="一句话介绍项目能为空（限制20字）"  >
...
<!-- 	</div> -->
	...
	<div class="mb18 clearfix">
	 ...
	 <p class="fl col_blue">阅读并同意《<a class="col_blue" target="_blank" href="<%=path %>/common/FDFagreement.html?pdf=applyPublicServiceAgreement">乐视金融众筹发起人协议</a>》</p>
	</div>
	<div class="mb18 clearfix">
	 <span class="fl"> </span>
...
<script type="text/javascript" src="<%=path%>/js/project/enterPubBenefit.js"></script>