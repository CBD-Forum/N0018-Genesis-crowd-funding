...
<div class="navDiv" style="width:1175px;margin:0 auto;">
    <a href="<%=path%>/common/zcSchool.html">众筹学院</a> &gt; <a href="<%=path%>/common/zcKnowList.html?type=info">行业资讯</a> &gt; <span id="breadTop" class="zc_bread_top"></span>
</div>
...
<script type="text/javascript" src="<%=path%>/js/zcSchool/zcKnowZXDetail.js"></script>